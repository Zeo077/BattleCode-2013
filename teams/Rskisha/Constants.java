...
public interface Constants {
    ...
    public static final int CHANNEL_CYCLE = 2500;//17;  
    ...
    public static final int SQUAD_1 = 1;
    public static final int SQUAD_2 = 2;
    public static final int SQUAD_3 = 3;
    public static final int SQUAD_4 = 4;
    public static final int SQUAD_5 = 5;
    public static final int DEFENSE_SQUAD = 6;
    public static final int DEMINE_SQUAD = 7;
}